  ...
  return (
    <footer className="container mx-auto px-4 py-8">
      <div className="flex flex-col items-center text-center">
        <img src="/footer-logo.png" alt="Brand Logo" className="w-16 h-16 mb-4" />
        <h2 className="text-lg font-semibold mb-2">A brand that strives to inspire and push creative culture forward.</h2>
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          ...
          <img src="/amex.webp" alt="American Express" className="h-8" />
          <img src="/paypal.png" alt="PayPal" className="h-8" />
          <img src="/diners.png" alt="Diners Club" className="h-8" />
